...
public final class Settings extends FlightSettings {
	...
	public static ConfigEntry GUI_MAIN_VIEW_ITEMS_SHIPPING = create("gui.main view.items.shipping.item", CompMaterial.ELYTRA.name());
	public static ConfigEntry GUI_MAIN_VIEW_ITEMS_SHIPPING_SLOT = create("gui.main view.items.shipping.slot", 4, "Set to -1 to disable icon");
